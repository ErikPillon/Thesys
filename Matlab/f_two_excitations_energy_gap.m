function [energy_gap] = f_two_excitations_energy_gap(delta, delta2, site, ratio, theta, alpha, c) 
% 
...
gap1 = f_one_excitation_energy_gap(delta, ratio, theta, alpha, c)
gap2 = f_one_excitation_energy_gap(delta2, ratio, theta, alpha, c)
...
diff1_r = 1/norm(-delta+dist+delta')^alpha;

diff2_f = 1/norm(-delta'+dist)^alpha;
diff2_r = 1/norm(-delta'-dist+delta)^alpha;
